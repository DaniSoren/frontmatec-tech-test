...
To update the database use this command from the Web project folder (replace `FrontmatecTechTest` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FrontmatecTechTest.Infrastructure/FrontmatecTechTest.Infrastructure.csproj -s FrontmatecTechTest.Web.csproj
```
